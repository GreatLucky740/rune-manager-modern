...
$pending=Join-Path $directory 'Rune_Premium_Icons_v2.pending.exe'
$backup=Join-Path $directory ('Rune_Manager_Modern_Core.backup-premium-icons-'+(Get-Date -Format 'yyyyMMdd-HHmmss')+'.exe')
