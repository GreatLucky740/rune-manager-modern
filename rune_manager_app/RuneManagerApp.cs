...
namespace RuneManagerModern {
  ...
  sealed partial class MainForm:Form {
    ...
    void ApplyLanguage(){
      ...
      LayoutToolbar();
      if(all.Count>0){RuneEngine.Calculate(all);FillFilters();if(viewMode=="obtained")SortObtained();else if(viewMode=="reeval")SortReeval();else RefreshGrid();}
      applyingLang=false;
    }
